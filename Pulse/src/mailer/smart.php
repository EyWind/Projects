...
$mail->Username = 'willSandFrom@Gmail.com';                 // Наш логин
$mail->Password = 'yourPassword';                 // Наш пароль от ящика
$mail->SMTPSecure = 'ssl';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to
 
$mail->setFrom('willSandFrom@Gmail.com', 'Pulse');   // От кого письмо ,  use same name as "Username" on top
